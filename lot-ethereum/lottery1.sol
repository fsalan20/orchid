...
contract OrchidLottery1 {
    ...
    function move(address funder, address signer, IERC20 token, uint256 amount, uint256 adjust_retrieve) external {
        require(token.transferFrom(funder, address(this), amount));
        move_(funder, signer, token, amount, adjust_retrieve);
    }
